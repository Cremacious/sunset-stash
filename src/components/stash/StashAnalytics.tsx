import { Star, Container, Dna } from 'lucide-react';
  ...
  return (
    <div className="">
      <div className="flex flex-col gap-4 glassCard">
        ...
        <div className="bg-gradient-to-br from-orange-50 via-orange-100 to-orange-200 rounded-xl p-6 border-b-orange-500 border-b-4 border-orange-200 hover:shadow-lg transition-all duration-300">
        ...
        <div className="bg-gradient-to-br from-red-50 via-red-100 to-red-200 rounded-xl p-6 border-b-4 border-b-red-500 border-red-200 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
