  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-yellow-50 p-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/80 backdrop-blur-sm border border-orange-200 rounded-2xl shadow-xl p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-8">Add Purchase</h1>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="bg-gray-50/80 backdrop-blur-sm border border-gray-200 rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700">Dispensary Name</FormLabel>
                        <FormControl>
                          <Input 
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700">Purchase Date</FormLabel>
                        <Popover>
                          <PopoverTrigger asChild>
                            <FormControl>
                              <Button
                                variant="outline"
                                className={cn(
                                  'w-full pl-3 text-left font-normal border-orange-200 focus:border-orange-400',
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="mt-4">
                      ...
                      <FormDescription>Any additional notes about this purchase</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
              ...
              <div className="bg-gray-50/80 backdrop-blur-sm border border-gray-200 rounded-xl p-6">
                ...
                <div className="space-y-6">
                  {fields.map((field, index) => (
                    <div key={field.id} className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-lg p-6 relative">
                      {fields.length > 1 && (
                        <Button
                          type="button"
                          variant="ghost"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700">Strain Name</FormLabel>
                              <FormControl>
                                <Input 
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700">THC %</FormLabel>
                              <FormControl>
                                <Input 
                                  type="number"
                                  step="0.1"
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700">CBD %</FormLabel>
                              <FormControl>
                                <Input 
                                  type="number"
                                  step="0.1"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-gray-700">Lineage</FormLabel>
                              <FormControl>
                                <Input 
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              Share your experiences, effects, taste, aroma, or any other notes
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
              ...
              <div className="flex justify-end">
                <Button 
                  type="submit" 
                  className="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white px-8 py-2 rounded-lg font-semibold"
                >
                  Save Purchase
                </Button>
              </div>
