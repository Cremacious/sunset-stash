  ...
  return (
    <div>
      <div className=" h-full space-y-4">
        <div className="text-xl font-bold text-gray-800 flex items-center justify-between bg-gradient-to-br from-orange-100 via-red-100 to-orange-100 p-4 rounded-lg shadow-md border-b-4 border-b-orange-300">
          <div className="flex items-center permanent-marker-font text-2xl md:text-3xl text-orange-700">
            Recent Purchases
          </div>
