...
const QuickActions = () => {
  return (
    <div className="bg-gradient-to-br from-yellow-200 via-red-200 to-purple-200 rounded-lg p-3 border-b-purple-300 border-b-4 shadow-lg hover:shadow-xl transition-all duration-300">
