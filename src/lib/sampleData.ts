...
export const sampleStashItems = [
  ...
  },
  {
    ...
    notes:
      'Beautiful purple buds with grape and berry flavors. Relaxing body high perfect for evening wind-down.',
  ...
  },
  {
    ...
    notes:
      'Award-winning sativa with spicy pine flavor. Provides clear-headed creativity and focus. Named after the cannabis activist.',
  ...
  },
  {
    ...
    notes:
      'Tropical fruit flavors with a smooth smoke. Balanced effects that are both relaxing and uplifting.',
  ...
  },
  {
    ...
    notes:
      'Sweet and earthy flavors with euphoric effects. Great for stress relief and creativity. Popular west coast strain.',
...
export const samplePurchases = [
  {
    ...
    total: 89.5,
    notes:
      'First visit to this location. Great customer service and knowledgeable staff.',
  ...
  },
  {
    ...
    total: 95.5,
    notes:
      'Great selection of vapes and flower. Staff recommended Purple Haze.',
...
export const samplePosts = [
  ...
  },
  {
    ...
    content:
      'Having a great movie night with some OG Kush. This indica is perfect for relaxing and getting into the zone. Watching some classic sci-fi films.',
    createdAt: new Date('2025-01-12'),
    userId: 'user-1',
    stashItems: [
      {
        ...
        stashItem: {
          ...
          lineage: 'Chemdawg x Lemon Thai x Pakistani Kush',
          notes:
            'Heavy hitting indica perfect for evening use. Helps with sleep and pain relief.',
          dateAdded: new Date('2025-01-12'),
          userId: 'user-1',
        },
      },
  ...
  },
  {
    ...
    activity: 'Workout',
    content:
      'Green Crack before my morning workout was a game changer! The energy boost is incredible and I feel so focused. Definitely adding this to my pre-workout routine.',
    createdAt: new Date('2025-01-10'),
    userId: 'user-1',
    stashItems: [
      {
        ...
        stashItem: {
          ...
          lineage: 'Skunk #1 x Sweet Leaf Indica',
          notes:
            'Energizing sativa great for daytime use. Provides focus and creativity boost.',
          dateAdded: new Date('2025-01-10'),
          userId: 'user-1',
        },
      },
  ...
  },
  {
    ...
    activity: 'Gaming',
    content:
      "Gorilla Glue #4 concentrate + gaming session = perfect evening. The focus is incredible and the couch-lock isn't too overwhelming. Great for strategy games.",
    createdAt: new Date('2025-01-08'),
    userId: 'user-1',
    stashItems: [
      {
        ...
        stashItem: {
          ...
          lineage: 'Chem Sister x Sour Dubb x Chocolate Diesel',
          notes:
            'Potent hybrid concentrate with strong couch-lock effects. Excellent for pain management.',
          dateAdded: new Date('2025-01-08'),
          userId: 'user-1',
        },
      },
  ...
  },
  {
    ...
    content:
      'Purple Haze vape at the beach with friends. The social effects are perfect and the berry flavor is so smooth. Nothing beats a sunset session with good company.',
    createdAt: new Date('2025-01-05'),
    userId: 'user-1',
    stashItems: [
      {
        ...
        stashItem: {
          ...
          lineage: 'Purple Thai x Haze',
          notes:
            'Classic sativa in vape form. Uplifting and euphoric effects with sweet berry flavors.',
          dateAdded: new Date('2025-01-05'),
          userId: 'user-1',
        },
      },
  ...
  },
  {
    ...
    activity: 'Chill Time',
    content:
      'White Widow for a chill Sunday afternoon. The balanced effects are perfect for relaxation without being too sedating. Great for reading or light activities.',
    createdAt: new Date('2025-01-03'),
    userId: 'user-1',
    stashItems: [
      {
        ...
        stashItem: {
          ...
          lineage: 'Brazilian Sativa x South Indian Indica',
          notes:
            'Balanced hybrid with resin-covered buds. Provides both mental clarity and physical relaxation.',
          dateAdded: new Date('2025-01-03'),
          userId: 'user-1',
        },
      },
  ...
  },
  {
    ...
    activity: 'Sleep Time',
    content:
      'Northern Lights gummies before bed = best sleep ever. The indica effects are perfect for winding down and the fruity flavor is delicious. Sweet dreams!',
    ...
    stashItems: [
      {
        ...
        stashItem: {
          ...
          lineage: 'Afghani x Thai',
          notes:
            'Classic indica in gummy form. Perfect for nighttime use and sleep aid.',
          dateAdded: new Date('2025-01-01'),
          userId: 'user-1',
        },
      },
  ...
  },
  {
    ...
    content:
      'Sour Diesel and a morning hike through the trails. The energizing effects are perfect for outdoor activities. The diesel aroma pairs well with fresh air!',
    createdAt: new Date('2024-12-28'),
    userId: 'user-1',
    stashItems: [
      {
        ...
        stashItem: {
          ...
          lineage: 'Chemdawg 91 x Super Skunk',
          notes:
            'Energizing sativa with diesel-like aroma. Great for daytime productivity and mood enhancement.',
          dateAdded: new Date('2024-12-28'),
          userId: 'user-1',
        },
      },
  ...
  },
  {
    ...
    content:
      'Granddaddy Purple + vinyl records = musical bliss. The relaxing effects really enhance the listening experience. Those grape flavors are incredible too.',
    createdAt: new Date('2024-12-25'),
    userId: 'user-1',
    stashItems: [
      {
  ...
  },
  {
    ...
    activity: 'Creative Time',
    content:
      'Jack Herer for some art time. The clear-headed creativity boost is amazing for painting. This award-winning strain definitely lives up to its reputation.',
    createdAt: new Date('2024-12-22'),
    userId: 'user-1',
    stashItems: [
      {
        ...
        stashItem: {
          ...
          lineage: 'Haze x Northern Lights #5 x Shiva Skunk',
          notes:
            'Award-winning sativa with spicy pine flavor. Provides clear-headed creativity and focus.',
          dateAdded: new Date('2024-12-22'),
          userId: 'user-1',
        },
      },
  ...
  },
  {
    ...
    activity: 'Munchies',
    content:
      'Zkittlez and some homemade cookies. The tropical fruit flavors of this strain pair perfectly with sweet treats. Balanced effects make it great for cooking too.',
    createdAt: new Date('2024-12-20'),
    userId: 'user-1',
    stashItems: [
      {
  ...
  },
  {
    ...
    activity: 'Chill Time',
    content:
      'Girl Scout Cookies concentrate for a relaxing evening. The sweet and earthy flavors are incredible and the euphoric effects are perfect for unwinding after work.',
    createdAt: new Date('2024-12-18'),
    userId: 'user-1',
    stashItems: [
      {
        ...
        stashItem: {
          ...
          lineage: 'OG Kush x Durban Poison',
          notes:
            'Sweet and earthy flavors with euphoric effects. Great for stress relief and creativity.',
          dateAdded: new Date('2024-12-18'),
          userId: 'user-1',
        },
      },
